...
def main():
    ...
    # Load Falcon-H1 histories from subdirectory
    falcon_dir = results_dir / "falcon_seq128"
    with open(falcon_dir / "falcon_h1_01_seq128_history.json") as f:
        falcon_01_history = json.load(f)

    with open(falcon_dir / "falcon_h1_025_seq128_history.json") as f:
